    ...
    def exec_cmd(
        ...
        if (run_isolated or skill_isolated):
            ...
            if workdir_root:
                ...
                # Router already creates its own isolation directory, so tell it not to
                # We've already created the isolated workdir ourselves
        ...
        if state.run_root and created_isolated_workdir:
            pass  # Already locked the workdir earlier
